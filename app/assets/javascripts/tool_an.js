...
Anchor.prototype.bind = function () {
  ...
  anchor.addEvent(window, "scroll", function () {
    var top = document.body.scrollTop || document.documentElement.scrollTop;
    if (top > self.height) {
      if (self.currNode == null) {
        self.currNode = self.createTopElement();
      }
      //ios 6.0 android 4.0一下版本定位
      var os = self.getOSVersion();
      ...
      if (!self.isBindEvent) {
        ...
        self.currNode.onmousedown = function () {
          self.addClass(self.currNode, "m-r-top-touch");
        }
      ...
      //					self.currNode.addEventListener(touchStartEvent, function () {
      //						self.addClass(self.currNode, "m-r-top-touch");
      //					}, false);
      //					self.currNode.addEventListener(touchEndEvent, function () {
      //						self.removeClass(self.currNode, "m-r-top-touch");
      //						var top = document.body.scrollTop || document.documentElement.scrollTop;
      //						self.scrollAnimate(top, 0);
      //					}, false);
    } else {
...
Anchor.prototype.getOSVersion = function () {
  var tempVersion = 10;
  var ua = navigator.userAgent, app = navigator.appVersion;
  var b = { android: ua.indexOf('Android') > -1 || ua.indexOf('Linux') > -1,
